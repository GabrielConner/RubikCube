...
public:
  ...
  void SetTo(uint8_t* planes, CubeCorner* corners);

  void MakeCopy(uint8_t* planes, CubeCorner* corners) const;


  CornerCube() : cubiePlanes(nullptr), cubieCorners(nullptr), front(nullptr), back(nullptr), left(nullptr), right(nullptr), down(nullptr), up(nullptr) {
